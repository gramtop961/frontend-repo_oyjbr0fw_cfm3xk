          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <div className="mb-4 flex flex-wrap gap-2">
                ...
                <Badge>Curious</Badge>
                <Badge>Builder</Badge>
                <Badge>Atharva College of Engineering</Badge>
              </div>
      ...
      <section id="about" className="mx-auto max-w-6xl px-4 py-16">
        ...
        <div className="mt-6 grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2 text-gray-700 leading-relaxed">
            ...
            <p className="mt-4">
              Education so far: I completed my <span className="font-semibold text-gray-900">SSC at St. Anne’s High School</span>, then my <span className="font-semibold text-gray-900">HSC at Bombay Suburban Grain Dealers (BSGD) College</span>. I’m currently pursuing my First Year at <span className="font-semibold text-gray-900">Atharva College of Engineering</span>.
            </p>
            <p className="mt-4">
