      ...
      <section id="about" className="mx-auto max-w-6xl px-4 py-16">
        ...
        <div className="mt-6 grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2 text-gray-700 leading-relaxed">
            ...
            <p className="mt-4">
              Education so far: I completed my HSC at <span className="font-semibold text-gray-900">Bombay Suburban Grain Dealers (BSGD) College</span> and my SSC at <span className="font-semibold text-gray-900">St. Anne’s High School</span>. I’m currently pursuing my First Year at <span className="font-semibold text-gray-900">Atharva College of Engineering</span>.
            </p>
            <p className="mt-4">
